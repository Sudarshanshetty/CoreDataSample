...
-(void)getClubName:(NSString*)inClubname
{
    ...
    NSPredicate *thePredicate= [NSPredicate predicateWithFormat:@"club.clubname == %@",inClubname];

    mPlayerlistArray= [[NSMutableArray alloc]initWithArray:  [CoreDataManager retrieveAllRecordsForEntity:@"Players" withPredicate:thePredicate]]; ;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text=theplayer.playerName;
